        ...
        <section id="team" className="pt-14 sm:pt-20 lg:pt-[130px]">
            <div className="px-4 xl:container">
                ...
                >
                    ...
                    <h2
                        className="font-heading text-dark mx-auto mb-5 max-w-[620px] text-3xl font-semibold sm:text-4xl md:text-[50px] md:leading-[60px] dark:text-white"
                    >
                ...
                <div className="-mx-4 flex flex-wrap justify-center">
                    <div className="w-full px-4 md:w-1/2 lg:w-1/4">
                        <div
                            className="wow fadeInUp xs:max-w-[370px] group mx-auto mb-10 max-w-[300px] text-center"
                            data-wow-delay=".2s"
                        >
                                ...
                                >
                                    <div className="flex items-center justify-center space-x-3">
                                        <a
                                            ...
                                            className="hover:bg-primary flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/10 text-white backdrop-blur-sm transition hover:border-transparent"
                                        >
                                            <svg
                                                width="20"
                                                height="20"
                            ...
                            <div>
                                <h3
                                    className="font-heading text-dark mb-1 text-xl font-medium sm:text-2xl dark:text-white"
                                >
                                    Olivia Andrium
                                </h3>
                                ...
                                >
                                    <div className="flex items-center justify-center space-x-3">
                                        <a
                                            ...
                                            name="social-icon"
                                            aria-label="social-icon"
                                            className="hover:bg-primary flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/10 text-white backdrop-blur-sm transition hover:border-transparent hover:opacity-100"
                                        >
                                            <svg
                                                width="20"
                                                height="20"
