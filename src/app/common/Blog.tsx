                        ...
                        <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                            <div className="wow fadeInUp mb-10" data-wow-delay=".2s">
                                <div className="relative mb-8 overflow-hidden rounded-sm">
                                    ...
                                    <span
                                        className="bg-primary font-heading absolute top-5 left-5 rounded-sm px-4 py-[6px] text-sm font-medium text-white"
                                    >
                                        Online Business
                                    </span>
                                </div>
                                <div>
                                    <div className="mb-4 flex items-center">
                                        <p
                                            className="font-heading text-dark-text flex items-center pr-5 text-base"
                                        >
                                            <span className="pr-2">
                                                <svg
                                                    width="18"
                                        ...
                                        <p
                                            className="font-heading text-dark-text flex items-center text-base"
                                        >
                                            <span className="pr-2">
                                                <svg
                                                    width="18"
