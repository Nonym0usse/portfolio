    ...
    return (
        <section id="cta" className="pt-14 sm:pt-20 lg:pt-[130px]">
            <div className="px-4 xl:container">
                <div
                    className="wow fadeInUp drop-shadow-light relative overflow-hidden bg-cover bg-center px-10 py-[60px] sm:px-[70px] dark:drop-shadow-none"
                    data-wow-delay=".2s"
                >
                    <div
                    ...
                    <div className="-mx-4 flex flex-wrap items-center">
                        <div className="w-full px-4 lg:w-2/3">
                            <div
                                className="mx-auto mb-10 max-w-[550px] text-center lg:mb-0 lg:ml-0 lg:text-left"
                            >
                                <h2
                                    className="font-heading text-dark mb-4 text-xl leading-tight font-semibold sm:text-[38px] dark:text-white"
                                >
