        ...
        <section id="about" className="pt-14 sm:pt-20 lg:pt-[130px]">
            <div className="px-4 xl:container">
                ...
                >
                    ...
                    <h2
                        className="font-heading text-dark mx-auto mb-5 max-w-[570px] text-3xl font-semibold sm:text-4xl md:text-[50px] md:leading-[60px] dark:text-white"
                    >
                ...
                <div
                    className="wow fadeInUp relative z-10 overflow-hidden rounded-sm px-8 pt-0 pb-8 md:px-[70px] md:pb-[70px] lg:px-[60px] lg:pb-[60px] xl:px-[70px] xl:pb-[70px]"
                    data-wow-delay=".3s"
                >
                    <div
                    ...
                    <div className="tabButtons flex w-full items-center justify-around">
                        <button
                            className="font-heading hover:border-primary hover:text-primary dark:hover:border-primary w-full border-b px-2 pt-8 pb-6 text-base font-medium lg:pt-9 lg:pb-7 dark:border-[#4B4E56] dark:text-white"
                        >
                            About Us
                        </button>
                        <button
                        ...
                        <div className="tabPanel">
                            <div className="-mx-4 flex w-full flex-wrap items-center pt-[70px]">
                                <div className="w-full px-4 lg:w-1/2">
                                    <div
                                        className="relative z-30 mb-14 h-[490px] max-w-[600px] lg:mb-0"
                                    >
                                        ...
                                        <div className="absolute top-1/2 right-0 z-10 -translate-y-1/2">
                                            ...
                                            <div
                                                className="border-primary/10 bg-primary/5 absolute -top-5 -left-5 -z-10 h-full w-full border backdrop-blur-[6px] dark:border-white/10 dark:bg-white/10"
                                            ></div>
                                        </div>
                                ...
                                <div className="w-full px-4 lg:w-1/2">
                                    <div className="max-w-[565px] lg:ml-auto">
                                        <h2
                                            className="font-heading text-dark mb-8 text-2xl font-bold sm:text-[40px] sm:leading-[50px] dark:text-white"
                                        >
