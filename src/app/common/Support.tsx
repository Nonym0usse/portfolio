            ...
            <div className="px-4 xl:container">
                <div className="-mx-4 flex flex-wrap justify-center">
                    <div className="w-full px-4 xl:w-10/12">
                        <div
                            className="flex flex-wrap items-center border-b pb-14 lg:pb-0 dark:border-[#2E333D]"
                        >
                            <div className="w-full px-4 lg:w-1/2">
                                ...
                                >
                                    ...
                                    <h2
                                        className="font-heading text-dark mb-5 text-3xl font-semibold sm:text-4xl md:text-[50px] md:leading-[60px] dark:text-white"
                                    >
                            ...
                            <div className="w-full px-4 lg:w-1/2">
                                ...
                                >
                                    <span
                                        className="bg-dark mr-10 h-1 w-full max-w-[200px] dark:bg-white"
                                    ></span>
                                    <a
                        ...
                        >
                            <div className="w-full px-4 md:w-1/2 lg:w-1/4">
                                <div className="mb-6">
                                    <h3
                                        className="font-heading text-dark mb-2 text-base sm:text-xl dark:text-white"
                                    >
                                        Email Address
                                    </h3>
                            ...
                            <div className="w-full px-4 sm:w-1/2">
                                <div className="mb-12">
                                    ...
                                    <input
                                        ...
                                        className="text-dark placeholder-dark-text focus:border-primary w-full border-b bg-transparent py-5 text-base font-medium outline-hidden dark:border-[#2C3443] dark:text-white dark:focus:border-white"
                                    />
                                </div>
                            </div>
                            <div className="w-full px-4 sm:w-1/2">
                            ...
                            <div className="w-full px-4">
                                <div className="mb-10">
                                    ...
                                    <textarea
                                        ...
                                        className="text-dark placeholder-dark-text focus:border-primary w-full resize-none border-b bg-transparent py-5 text-base font-medium outline-hidden dark:border-[#2C3443] dark:text-white dark:focus:border-white"
                                    ></textarea>
                                </div>
                            </div>
                                ...
                                <div className="mb-12">
                                    ...
                                    >
                                        <div className="relative">
                                            ...
                                            />
                                            <div
                                                className="box mt-1 mr-4 flex h-5 w-5 items-center justify-center rounded-sm border dark:border-[#414652]"
                                            >
