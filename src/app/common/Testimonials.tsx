export default function Testimonials() {
    ...
    return (<section id="testimonial" className="pt-14 sm:pt-20 lg:pt-[130px]">
        <div className="px-4 xl:container">
            ...
            <div className="w-full px-4">
                <div
                    className="wow fadeInUp drop-shadow-light relative z-10 overflow-hidden rounded-sm bg-cover bg-center px-10 pt-[60px] pb-28 sm:px-14 md:p-[70px] md:pb-28 lg:pb-[70px] dark:drop-shadow-none"
                    data-wow-delay=".3s"
                >
                    <div
                            ...
                            <div className="-mx-4 flex flex-wrap items-center">
                                <div className="order-last w-full px-4 lg:order-first lg:w-1/2">
                                    <div className="text-center lg:text-left">
                                        <p
                                            className="font-heading text-dark-text mb-9 text-base font-light lg:text-lg xl:text-2xl"
                                        >
                                ...
                                <div className="w-full px-4 lg:w-1/2">
                                    ...
                                    >
                                        <div className="absolute top-5 right-5 z-10">
                                            ...
                                            />
                                            <div
                                                className="border-primary/10 bg-primary/5 dark:border-opacity-10 absolute -top-5 -right-5 -z-10 h-full w-full border backdrop-blur-[6px] dark:border-white/10 dark:bg-white/10"
                                            ></div>
                                        </div>
