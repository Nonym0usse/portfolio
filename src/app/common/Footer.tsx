                        ...
                        <div className="mb-20">
                            ...
                            <form className="relative">
                                <input
                                    ...
                                    className="pladeholder-opacity-40 text-dark-text focus:border-primary w-full rounded-sm border py-3 pr-12 pl-5 text-base outline-hidden dark:border-transparent dark:bg-[#2C3443]"
                                />
                                <button
                                    className="text-dark-text absolute top-0 right-0 flex h-full w-12 items-center justify-center border-l dark:border-[#1F2633]"
                                >
                                    <svg
                                        width="20"
                                        height="20"
                ...
                <div className="md:border-t dark:border-[#2E333D]">
                    <div className="-mx-4 flex flex-wrap py-5 md:py-7">
                        <div className="w-full px-4 md:w-1/2 lg:w-2/3">
                            <div
                                className="mb-5 flex items-center justify-center space-x-5 border-b pb-5 md:mb-0 md:justify-start md:border-0 md:pb-0 dark:border-[#2E333D]"
                            >
                                <a
                                    href="javascript:void(0)"
                                    className="font-heading text-dark-text hover:text-primary text-base"
                                >
                                    English
                                </a>
                                <a
