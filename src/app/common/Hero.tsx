export default function Hero() {
    return (
        ...
        >
            <div className="px-4 xl:container">
                <div className="-mx-4 flex flex-wrap items-center">
                    <div className="w-full px-3 lg:w-1/2">
                        <div
                            className="mx-auto mb-12 max-w-[530px] text-center lg:mb-0 lg:ml-0 lg:text-left"
                        >
                            <h1
                                className="wow fadeInUp font-heading mb-5 text-2xl font-semibold sm:text-4xl md:text-[50px] md:leading-[60px] dark:text-white"
                                data-wow-delay=".3s"
                            >
                                Des sites rapides, beaux et prêts à performer
                                <span
                            ...
                            <p
                                className="wow fadeInUp text-dark-text mb-12 text-base"
                                data-wow-delay=".4s"
                            >
                                Bienvenue ! Je suis Cyril Vella, développeur web fullstack, et je propose mes services via mon studio freelance spécialisé dans le développement d’applications web sur-mesure avec les dernières technologies.
                            </p>
                            <div
                    ...
                    <div className="w-full px-4 lg:w-1/2">
                        ...
                        >
                            ...
                            <div className="absolute bottom-0 left-0 z-10">
                                ...
                                <div
                                    className="border-primary/10 bg-primary/5 absolute -top-6 -right-6 -z-10 h-full w-full border backdrop-blur-[6px] dark:border-white/10 dark:bg-white/10"
                                ></div>
                            </div>
            ...
            <div
                className="bg-noise-pattern absolute bottom-0 left-0 -z-10 h-full w-full bg-cover bg-center opacity-10 dark:opacity-40"
            ></div>
