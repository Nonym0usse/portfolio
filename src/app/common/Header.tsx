            ...
            >
                ...
                >
                    ...
                    >
                        <a
                            href="signup.html"
                            className="bg-primary font-heading hover:bg-primary/90 w-full rounded-sm px-6 py-3 text-center whitespace-nowrap text-white lg:w-auto"
                        >
                            Sign In
                        </a>
                        <a
                            href="signup.html"
                            className="font-heading w-full rounded-sm bg-[#222C40] px-6 py-3 text-center whitespace-nowrap text-white hover:bg-[#222C40]/90 lg:w-auto"
                        >
                            Sign Up
                        </a>
                    </div>
                ...
                >
                    <label
                        htmlFor="darkToggler"
                        className="bg-gray-2 dark:bg-dark-bg relative z-40 flex h-9 w-9 cursor-pointer items-center justify-center rounded-full text-black md:h-14 md:w-14 dark:text-white"
                    >
                        <input
                            type="checkbox"
                            name="darkToggler"
                        ...
                        <svg
                            viewBox="0 0 23 23"
                            className="h-5 w-5 stroke-current md:h-6 md:w-6 dark:hidden"
                            fill="none"
                        >
                            <path
                        ...
                        <svg
                            ...
                            className="hidden h-5 w-5 md:h-6 md:w-6 dark:block"
                        >
                    ...
                    <button
                        className="menu-toggler text-dark relative z-50 lg:hidden dark:text-white"
                    >
                        <svg
                            width="28"
                            height="28"
